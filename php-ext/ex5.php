  ...
  <fieldset>
    <legend>Ejercicio 5</legend>
     ...
     <div class="form-group">
      ...
      <div class="col-lg-10">
        <select class="form-control" id="select" name="art">
          <option value="660000">1 Tablet</option>
      ...
      <div class="col-lg-10">
          <select class="form-control" id="select" name="clav">
          <option value="10">Clave 1 - 10% descuento</option>
          <option value="20">Clave 2 - 20% descuento</option>
     </select>
      </div>
    </div>
   <div class="form-group">
