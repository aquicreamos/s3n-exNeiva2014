...
<div class="row">
      <div class="col-md-12">
    <form class="form-horizontal" action="parametros3.php" method="GET">
  <fieldset>
    <legend>Ejercicio 3</legend>
    <div class="form-group ">
      <label for="inputEmail" class="col-lg-3 control-label inemail">Nombre del Paciente.</label>
      <div class="col-lg-9">
        <input type="text" class="form-control inemail" id="inputEmail" name="ven" placeholder="Nombre del Paciente"  >
      </div>
      <label for="inputEmail" class="col-lg-3 control-label inemail">Peso en Kg.</label>
      <div class="col-lg-9">
        <input type="text" class="form-control inemail" id="inputEmail" name="can" placeholder="Peso en Kilogramos" >
      </div>
      <label for="inputEmail" class="col-lg-3 control-label inemail">Estatura en mtrs. </label>
      <div class="col-lg-9">
        <input type="text" class="form-control inemail" id="inputEmail" name="tot" placeholder="Estatura en Metros" >
      </div>
